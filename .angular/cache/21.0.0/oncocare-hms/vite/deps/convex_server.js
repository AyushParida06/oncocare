...
function performAsyncSyscall(op, arg) {
  return __async(this, null, function* () {
    ...
    let resultStr;
    try {
      resultStr = yield Convex.asyncSyscall(op, JSON.stringify(arg));
    } catch (e) {
      if (e.data !== void 0) {
...
function setupActionCalls(requestId) {
  return {
    runQuery: (query, args) => __async(null, null, function* () {
      const result = yield performAsyncSyscall(
        "1.0/actions/query",
        syscallArgs(requestId, query, args)
      );
      return jsonToConvex(result);
    }),
    runMutation: (mutation, args) => __async(null, null, function* () {
      const result = yield performAsyncSyscall(
    ...
    runAction: (action, args) => __async(null, null, function* () {
      const result = yield performAsyncSyscall(
        "1.0/actions/action",
...
function setupActionVectorSearch(requestId) {
  return (tableName, indexName, query) => __async(null, null, function* () {
    ...
    return yield new VectorQueryImpl(
      requestId,
      tableName + "." + indexName,
      query
    ).collect();
...
var VectorQueryImpl = class {
  ...
  collect() {
    return __async(this, null, function* () {
      ...
      const { results } = yield performAsyncSyscall("1.0/actions/vectorSearch", {
...
function setupAuth(requestId) {
  return {
    getUserIdentity: () => __async(null, null, function* () {
      return yield performAsyncSyscall("1.0/getUserIdentity", {
        requestId
      });
    })
  };
...
var QueryInitializerImpl = class {
  ...
  count() {
    return __async(this, null, function* () {
      const syscallJSON = yield performAsyncSyscall("1.0/count", {
...
var QueryImpl = class _QueryImpl {
  ...
  next() {
    return __async(this, null, function* () {
      ...
      const { value, done } = yield performAsyncSyscall("1.0/queryStreamNext", {
        queryId
      });
      if (done) {
        this.closeQuery();
  ...
  paginate(paginationOpts) {
    return __async(this, null, function* () {
      ...
      const { page, isDone, continueCursor, splitCursor, pageStatus } = yield performAsyncSyscall("1.0/queryPage", {
        query,
        cursor,
        endCursor,
        pageSize,
...
function get(table, id, isSystem) {
  return __async(this, null, function* () {
    ...
    const syscallJSON = yield performAsyncSyscall("1.0/get", args);
...
function setupReader() {
  const reader = (isSystem = false) => {
    return {
      get: (arg0, arg1) => __async(null, null, function* () {
        return arg1 !== void 0 ? yield get(arg0, arg1, isSystem) : yield get(void 0, arg0, isSystem);
      }),
      query: (tableName) => {
  ...
  const _a = reader(true), { system: _ } = _a, rest = __objRest(_a, ["system"]);
  const r = reader();
  r.system = rest;
  return r;
}
function insert(tableName, value) {
  return __async(this, null, function* () {
    ...
    const syscallJSON = yield performAsyncSyscall("1.0/insert", {
      table: tableName,
...
function patch(table, id, value) {
  return __async(this, null, function* () {
    validateArg(id, 1, "patch", "id");
    validateArg(value, 2, "patch", "value");
    yield performAsyncSyscall("1.0/shallowMerge", {
      id: convexToJson(id),
...
function replace(table, id, value) {
  return __async(this, null, function* () {
    validateArg(id, 1, "replace", "id");
    validateArg(value, 2, "replace", "value");
    yield performAsyncSyscall("1.0/replace", {
      id: convexToJson(id),
      value: convexToJson(value),
      table
    });
...
function delete_(table, id) {
  return __async(this, null, function* () {
    ...
    yield performAsyncSyscall("1.0/remove", {
      id: convexToJson(id),
      table
    });
  });
...
function setupWriter() {
  ...
  return {
    ...
    insert: (table, value) => __async(null, null, function* () {
      return yield insert(table, value);
    }),
    patch: (arg0, arg1, arg2) => __async(null, null, function* () {
      return arg2 !== void 0 ? yield patch(arg0, arg1, arg2) : yield patch(void 0, arg0, arg1);
    }),
    replace: (arg0, arg1, arg2) => __async(null, null, function* () {
      return arg2 !== void 0 ? yield replace(arg0, arg1, arg2) : yield replace(void 0, arg0, arg1);
    }),
    delete: (arg0, arg1) => __async(null, null, function* () {
      return arg1 !== void 0 ? yield delete_(arg0, arg1) : yield delete_(void 0, arg0);
    }),
    table: (tableName) => {
...
function setupMutationScheduler() {
  return {
    runAfter: (delayMs, functionReference, args) => __async(null, null, function* () {
      const syscallArgs2 = runAfterSyscallArgs(delayMs, functionReference, args);
      return yield performAsyncSyscall("1.0/schedule", syscallArgs2);
    }),
    runAt: (ms_since_epoch_or_date, functionReference, args) => __async(null, null, function* () {
    ...
    cancel: (id) => __async(null, null, function* () {
      validateArg(id, 1, "cancel", "id");
      const args = { id: convexToJson(id) };
      yield performAsyncSyscall("1.0/cancel_job", args);
    })
  };
}
function setupActionScheduler(requestId) {
  return {
    runAfter: (delayMs, functionReference, args) => __async(null, null, function* () {
      const syscallArgs2 = __spreadValues({
        requestId
      }, runAfterSyscallArgs(delayMs, functionReference, args));
      return yield performAsyncSyscall("1.0/actions/schedule", syscallArgs2);
    }),
    runAt: (ms_since_epoch_or_date, functionReference, args) => __async(null, null, function* () {
      const syscallArgs2 = __spreadValues({
        requestId
    ...
    cancel: (id) => __async(null, null, function* () {
      ...
      return yield performAsyncSyscall("1.0/actions/cancel_job", syscallArgs2);
    })
  };
}
...
function setupStorageReader(requestId) {
  return {
    getUrl: (storageId) => __async(null, null, function* () {
      validateArg(storageId, 1, "getUrl", "storageId");
      return yield performAsyncSyscall("1.0/storageGetUrl", {
        requestId,
        version,
        storageId
      });
    }),
    getMetadata: (storageId) => __async(null, null, function* () {
      return yield performAsyncSyscall("1.0/storageGetMetadata", {
        requestId,
        version,
        storageId
      });
...
function setupStorageWriter(requestId) {
  ...
  return {
    generateUploadUrl: () => __async(null, null, function* () {
      return yield performAsyncSyscall("1.0/storageGenerateUploadUrl", {
        requestId,
        version
      });
    }),
    delete: (storageId) => __async(null, null, function* () {
      yield performAsyncSyscall("1.0/storageDelete", {
        requestId,
        version,
        storageId
      });
...
function setupStorageActionWriter(requestId) {
  ...
  return __spreadProps(__spreadValues({}, writer), {
    store: (blob, options) => __async(null, null, function* () {
      return yield performJsSyscall("storage/storeBlob", {
        requestId,
        version,
        blob,
        options
    ...
    get: (storageId) => __async(null, null, function* () {
      return yield performJsSyscall("storage/getBlob", {
        requestId,
        version,
        storageId
      });
...
function getTransactionMetrics() {
  return __async(this, null, function* () {
    let syscallJSON;
    try {
      syscallJSON = yield performAsyncSyscall("1.0/getTransactionMetrics", {});
    } catch (e) {
...
function getFunctionMetadata() {
  return __async(this, null, function* () {
    const { name, componentPath } = yield performAsyncSyscall(
...
function getDeploymentMetadata() {
  return __async(this, null, function* () {
    const syscallJSON = yield performAsyncSyscall(
...
function getRequestMetadata() {
  return __async(this, null, function* () {
    const { ip, userAgent, requestId } = yield performAsyncSyscall(
...
function setupQueryMeta(visibility) {
  return {
    getFunctionMetadata: () => __async(null, null, function* () {
      return __spreadProps(__spreadValues({}, yield getFunctionMetadata()), {
        type: "query",
        visibility
      });
    }),
...
function invokeMutation(func, argsStr, visibility) {
  return __async(this, null, function* () {
    const requestId = "";
    ...
    const result = yield invokeFunction(func, mutationCtx, args);
...
function invokeFunction(func, ctx, args) {
  return __async(this, null, function* () {
    let result;
    try {
      result = yield Promise.resolve(func(ctx, ...args));
    } catch (thrown) {
...
function invokeQuery(func, argsStr, visibility) {
  return __async(this, null, function* () {
    const requestId = "";
    const args = jsonToConvex(JSON.parse(argsStr));
    const queryCtx = {
    ...
    const result = yield invokeFunction(func, queryCtx, args);
    validateReturnValue(result);
    return JSON.stringify(convexToJson(result === void 0 ? null : result));
  });
}
...
function invokeAction(func, requestId, argsStr, visibility) {
  return __async(this, null, function* () {
    globalThis.Convex?.setupPerformance?.();
    const args = jsonToConvex(JSON.parse(argsStr));
    const calls = setupActionCalls(requestId);
    const ctx = __spreadProps(__spreadValues({}, calls), {
      auth: setupAuth(requestId),
    ...
    const result = yield invokeFunction(func, ctx, args);
    return JSON.stringify(convexToJson(result === void 0 ? null : result));
  });
}
...
function invokeHttpAction(func, request) {
  return __async(this, null, function* () {
    globalThis.Convex?.setupPerformance?.();
    const requestId = "";
    const calls = setupActionCalls(requestId);
    ...
    return yield invokeFunction(func, ctx, [request]);
  });
}
...
function runUdf(udfType, f, args, transactionLimits) {
  return __async(this, null, function* () {
    ...
    const result = yield performAsyncSyscall("1.0/runUdf", syscallArgs2);
    return jsonToConvex(result);
  });
}
...
var Crons = class {
  ...
  interval(cronIdentifier, schedule, functionReference, ...args) {
    ...
    this.schedule(
      cronIdentifier,
      __spreadProps(__spreadValues({}, schedule), { type: "interval" }),
      functionReference,
      ...args
    );
  }
...
var HttpRouter = class {
  constructor() {
    ...
    __publicField11(this, "runRequest", (argsStr, requestRoute) => __async(this, null, function* () {
      ...
      const response = yield endpoint.invokeHttpAction(request);
      return JSON.stringify(
...
function createFunctionHandle(functionReference) {
  return __async(this, null, function* () {
    const address = getFunctionAddress(functionReference);
    return yield performAsyncSyscall("1.0/createFunctionHandle", __spreadProps(__spreadValues({}, address), {
      version
    }));
  });
}
...
function defineApp(options) {
  ...
  const ret = __spreadProps(__spreadValues(__spreadValues({
    _isRoot: true,
    _childComponents: [],
    _exportTree: {}
  }, httpPrefix !== void 0 ? { _httpPrefix: httpPrefix } : {}), env !== void 0 ? { _env: env } : {}), {
...
var audit = (body) => __async(null, null, function* () {
  yield performAsyncSyscall("1.0/auditLog", {
