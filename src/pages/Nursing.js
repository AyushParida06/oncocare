    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <div>
            <div style={{ fontSize: 22, fontWeight: 600, color: isDark ? '#e2e8f0' : '#111', marginBottom: 4 }}>
              {l('mod_nursing')}
            </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 20 }}>
        {cards.map(card => (
          ...
          onMouseEnter={e => {
            e.currentTarget.style.background = isDark ? '#1e2030' : '#f9fafb';
            e.currentTarget.style.transform = 'translateY(-2px)';
            e.currentTarget.style.boxShadow = isDark ? '0 8px 30px rgba(0,0,0,0.3)' : '0 8px 20px rgba(0,0,0,0.05)';
          }}
          onMouseLeave={e => {
            e.currentTarget.style.background = isDark ? '#1e2030' : '#fff';
          ...
          >
            <div style={{ 
              ...
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              border: `1px solid ${isDark ? '#2d3148' : `${card.color}30`}`
            }}>
              <i className={`ti ${card.icon}`} style={{ fontSize: 20 }} />
            </div>
            <div>
              <div style={{ fontSize: 15, fontWeight: 600, color: isDark ? '#e2e8f0' : '#111', marginBottom: 4 }}>
                {card.title}
              </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ padding: '20px 24px', borderBottom: `1px solid ${isDark ? '#2d3148' : '#eee'}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <button onClick={() => setActiveModal(null)} style={{ background: 'none', border: 'none', color: isDark ? '#64748b' : '#666', cursor: 'pointer', fontSize: 20 }}>&times;</button>
            </div>
            ...
            <form onSubmit={handleSaveVitals} style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div style={{ display: 'flex', gap: 16 }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6, flex: 1 }}>
                  <label style={{ fontSize: 13, fontWeight: 500, color: isDark ? '#64748b' : '#3a3f5c' }}>Heart Rate (bpm)</label>
                  <input 
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6, flex: 1 }}>
                  <label style={{ fontSize: 13, fontWeight: 500, color: isDark ? '#64748b' : '#3a3f5c' }}>Blood Pressure (mmHg)</label>
                  <input 
              ...
              <div style={{ display: 'flex', gap: 16 }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6, flex: 1 }}>
                  <label style={{ fontSize: 13, fontWeight: 500, color: isDark ? '#64748b' : '#3a3f5c' }}>SpO2 (%)</label>
                  <input 
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6, flex: 1 }}>
                  <label style={{ fontSize: 13, fontWeight: 500, color: isDark ? '#64748b' : '#3a3f5c' }}>Temperature (Â°F)</label>
                  <input 
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10, marginTop: 10 }}>
                <button type="button" onClick={() => setActiveModal(null)} style={{ padding: '10px 16px', borderRadius: 8, border: `1px solid ${isDark ? '#2d3148' : '#ddd'}`, background: 'transparent', color: isDark ? '#64748b' : '#3a3f5c', cursor: 'pointer', fontWeight: 500 }}>
                  Cancel
                </button>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <form onSubmit={async (e) => {
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                <label style={{ fontSize: 13, fontWeight: 500, color: isDark ? '#64748b' : '#3a3f5c' }}>Handover Observations & Plan</label>
                <textarea 
        ...
        <div style={{
          ...
          <div style={{
            ...
            <form onSubmit={async (e) => {
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                <label style={{ fontSize: 13, fontWeight: 500, color: isDark ? '#64748b' : '#3a3f5c' }}>Medication & Dosage Details</label>
                <input 
        ...
        <div style={{
          ...
          <div style={{
            ...
            <form onSubmit={async (e) => {
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                <label style={{ fontSize: 13, fontWeight: 500, color: isDark ? '#64748b' : '#3a3f5c' }}>Plan Title</label>
                <input 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                <label style={{ fontSize: 13, fontWeight: 500, color: isDark ? '#64748b' : '#3a3f5c' }}>Plan Interventions</label>
                <textarea 
